...
- **2026-08-04**: Plan 008 implemented. `dictate devices` lists unique input names with default and configured markers; `input_device` selects an exact name, and missing devices log a fallback before recording from the default. The debug preview was updated for the clean-break capture signature.
