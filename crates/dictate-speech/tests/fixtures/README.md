...
- Raw recognizer hypotheses are tracked by per-fixture model-backed integration snapshots and guarded by WER/CER thresholds. Formatter behavior belongs in `crates/dictate-speech/src/text.rs` snapshots.
